...
fraction absorbs _early_ (t_abs ≈ 29–58s) and the rest stabilize into an
...
**Plateau SURVIVES at A=0.5** and is _flatter_ than the graze curve: τ_abs ≈
...
(mirroring τ), so p(N) tracks the plateau but is an _average_ per-pass rate, not a
...
| ---------------- | ----- | ------ | ---- | ---------- |
| N=8 A=0.5        | 83    | 0.45   | 0.29 | 8.8e-04    |
| N=16 A=0.5       | 73    | 0.31   | 0.24 | 1.2e-02    |
| N=32 A=0.5       | 63    | 0.34   | 0.12 | 4.3e-01    |
| N=64 A=0.5       | 80    | 0.70   | 0.17 | 9.5e-02    |
| N=8 A=0.2        | 7     | 0.82   | 0.70 | 2.6e-02    |
| N=16 A=0.2       | 1     | 1.36   | 1.00 | 4.6e-01    |
| **pooled A=0.5** | 299   | 0.45   | 0.21 | 2.1e-06    |

Breath-locking is present for **deaths** but WEAK: the pooled A=0.5 distribution rejects
uniformity (p=2.1e-06) yet R̄=0.21 is small, and only
3/6 points reject individually (the N≥32 A=0.5 points are
uniform). So true absorptions are breath-_influenced_ but not sharply breath-locked — far
...
- **Breath-locking of collapse (WEAKLY)** — true absorptions are non-uniform in breath phase pooled (A=0.5 p=2.1e-06), but R̄=0.21 is small and only the smaller-N points reject uniformity individually (3/6; N≥32 are uniform). PR #41's tight graze-attempt clustering (R̄ 0.43–0.69) is much weaker for actual deaths — absorptions are breath-influenced but not sharply breath-locked. Significant pooled, weak in magnitude.
