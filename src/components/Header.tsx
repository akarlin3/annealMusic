...
export function Header({
  ...
  return (
    <header className="mb-8 flex flex-col md:flex-row md:items-baseline md:justify-between gap-6">
      <div>
        ...
        {subtitle && (
          <p
            className="mt-1 max-w-md font-body text-sm leading-relaxed"
            style={{ color: '#a8a29e' }}
          >
            {subtitle}
          </p>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {/* Page-specific Action Toolbar Slot */}
        {children}
      </div>
    </header>
  );
